...
class Menu:
    ...
    def menu_loop(self):
        pygame.font.init()
        font_menu = pygame.font.SysFont('IMPACT', 60)
...
def intro():
    ...
    text_font = pygame.font.SysFont('Segoe Script', 22)
...
def outcome(text):
    ...
    text_font1 = pygame.font.SysFont('COMIC SANS MS', 50, bold = True)
    text_font2 = pygame.font.SysFont('IMPACT', 25)

    title = text_font1.render(text, True, (255, 255, 0))
    info = text_font2.render('Нажмите ENTER', True, (255, 255, 0))
