...
class Menu:
    ...
    def menu_loop(self):
        pygame.font.init()
        font_menu = pygame.font.SysFont('Stencil', 100)
...
def intro():
    ...
    text4 = text_font.render('Ekraani allosas on InputBox, kuhu peab sisestama vastuseid.', True, (255, 255, 0))
...
def outcome(text):
    ...
    text_font1 = pygame.font.SysFont('Algerian', 80, bold = True)
    text_font2 = pygame.font.SysFont('Stencil', 40)
