...
def level(lives1, lives2, picts1, picts2, music, bg, gravity, character, system, difficulty):
    ...
    info_string = InfoString(0, 0, 1080, 30, text_font, (255, 0, 0), (0, 255, 255), u'Counting Systems Game', left_text = u'Sinu elud: {0}'.format(player.lives), right_text = u'Vaenlase elud: {0}'.format(enemy.lives))
